...
if lang eq it_IT
	...
	sz_Program_run_successfully db "Программа запущена успешно",0
	sz_File_not_found           db "Файл не найден",0
	sz_File_is_not_executable   db "Файл не является исполняемым",0
	sz_Too_many_processes       db "Слишком много процессов",0
	sz_Access_denied            db "Доступ запрещен",0
	sz_Out_of_memory            db "Недостаточно памяти",0
	sz_Unknown_error            db "Неизвестная ошибка",0
	sz_Type_name_of_program     db "Введите название программы",0
	sz_run                      db "Запустить",0
	sz_browse                   db "...",0
	title                       db "Запуск программы",0
else
