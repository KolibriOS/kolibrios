...
//ÃªÃ®Ã¯Ã¨Ã°Ã®Ã¢Ã Ã²Ã¼ Ã·Ã¥Ã°Ã¥Ã§ Ã¯Ã®Ã²Ã®Ãª
...
#include "lang.h--"
	...
	?define T_DELETE_FILE "‚ë ¤¥©áâ¢¨â¥«ì­® å®â¨â¥ ã¤ «¨âì"
	?define T_YES "„ "
	?define T_NO "¥â"
	?define T_DEL_ERROR_1 "Žè¨¡ª .  ¯ª  ­¥ ¯ãáâ ï."
	?define T_DEL_ERROR_2 "Žè¨¡ª . ” ©«®¢ ï á¨áâ¥¬  â®«ìª® ¤«ï çâ¥­¨ï."
	?define NOT_CREATE_FOLDER "¥ ã¤ «®áì á®§¤ âì ¯ ¯ªã."
	?define NOT_CREATE_FILE "¥ ã¤ «®áì á®§¤ âì ä ©«."
	?define ERROR_1 "Žè¨¡ª  ¯à¨ § £àã§ª¥ ¡¨¡«¨®â¥ª¨ /rd/1/lib/box_lib.obj"
...
{
	int paint_y;
	//Ã¥Ã±Ã«Ã¨ Ã¬Ã» Ã¢ ÃªÃ®Ã­Ã¶Ã¥ Ã±Ã¯Ã¨Ã±ÃªÃ  Ã´Ã Ã©Ã«Ã®Ã¢ Ã°Ã Ã§Ã¢Ã¥Ã°Ã­Â¸Ã¬ Ã®ÃªÃ­Ã® Ã¯Ã®Ã¿Ã¢Ã¿Ã²Ã¼Ã±Ã¿ Ã¯Ã³Ã±Ã²Ã¿Ã¥ Ã¡Ã¥Ã«Ã»Ã¥ ÃªÃ­Ã®Ã¯ÃªÃ¨
	//Ã½Ã²Ã® Ã¥Ã±Ã«Ã¨ Ã¢Ã»Ã¤Ã¥Ã«Ã¥Ã­Ã¨Ã¥ Ã¯Ã®Ã±Ã«Ã¥ Ã±ÃµÃ«Ã®Ã¯Ã»Ã¢Ã Ã­Ã¨Ã¿ Ã®ÃªÃ­Ã  Ã§Ã  ÃªÃ Ã¤Ã°Ã®Ã¬
