#define TITLE "Eolite File Manager v3.75"
#define ABOUT_TITLE "EOLITE 3.75"
	...
	?define T_NOTIFY_APP_PARAM_WRONG "'Параметр для запуска Eolite не верен: папка не сужествует!' -E"
