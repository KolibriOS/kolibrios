...
#ifdef LANG_RUS
	?define WINDOW_TITLE "Ќ бва®©ЄЁ Ї ­Ґ«Ё § ¤ з Ё „®Є "
    ?define TASK_FRAME_T "   Џ ­Ґ«м § ¤ з "
	?define DOCK_FRAME_T "   „®Є "
	?define MIN_LEFT_BUTTON "Љ­®ЇЄ  бЄалвЁп б«Ґў "
	?define MIN_RIGHT_BUTTON "Љ­®ЇЄ  бЄалвЁп бЇа ў "
	?define SOFTEN_UP   "‘Ј« ¦Ёў ­ЁҐ бўҐаег"
	?define SOFTEN_DOWN "‘Ј« ¦Ёў ­ЁҐ б­Ё§г"
	?define CLOCK    "— бл"
	?define CPU_USAGE "‡ Јаг§Є  –Џ"
	?define CHANGE_LANG "џ§лЄ ўў®¤ "
	?define MENU_BUTTON "Љ­®ЇЄ  ¬Ґ­о"
	?define PANEL_HEIGHT "‚лб®в  Ї ­Ґ«Ё"
	?define SOFTEN_HEIGHT "‚лб®в  бЈ« ¦Ёў ­Ёп"
	?define BUTTON_OFFSET "Џ®«Ґ ў®ЄагЈ Є­®Ї®Є"
	?define FSIZE "ђҐ¦Ё¬ Ї ­Ґ«Ё"
	?define ASHOW "ЌҐ бЄалў вм"
	?define CHANGE_POS "Ќ ¦¬ЁвҐ ­  Ё§®Ўа ¦Ґ­ЁҐ ¤«п б¬Ґ­л Ї®§ЁжЁЁ"
#else
