...
static const unsigned char cp866_page20[6] = {
  0x2d, 0x2d, 0x12, 0x12, 0x12, 0x12, /* 0x10-0x15 */  // 0x12 draws as a dash
};
...
cp866_wctomb (conv_t conv, unsigned char *r, ucs4_t wc, int n)
{
  ...
  else if (wc >= 0x2010 && wc < 0x2016)
    c = cp866_page20[wc-0x2010];
  else if (wc == 0x2116)
    c = 0xfc;
