...
inline fastcall dword GetFreeRAM()
{
	...
	$mov ebx, 16
	$int 0x40
	//return eax = ЁрчьхЁ ётюсюфэющ ярь Єш т ъшыюсрщЄрї
}

inline fastcall dword LoadDriver( ECX) //ECX - шь  фЁрщтхЁр
{
	$mov eax, 68
	$mov ebx, 16
	$int 0x40
	//return 0 - эхєфрўр, шэрўх eax = ї¤эфы фЁрщтхЁр 
}

inline fastcall dword RuleDriver( ECX) //єърчрЄхы№ эр єяЁрты ■∙є■ ёЄЁєъЄєЁє
{
	$mov eax, 68
	$mov ebx, 17
	$int 0x40
	//return eax = юяЁхфхы хЄё  фЁрщтхЁюь
}
