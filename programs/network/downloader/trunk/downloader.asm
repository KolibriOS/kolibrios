...
; find 'chunked'
; да, € копирую код, это ужасно, но мне хочетс€, чтобы поскорее заработало
...
err_msg_found_lib_0 db 'Н• ≠†©§•≠† °®°Ђ®Ѓв•™† ',39,'box_lib.obj',39,0
err_msg_import_0 db 'Ои®°™† ѓа® ®ђѓЃав• °®°Ђ®Ѓв•™® ',39,'box_lib',39,0
