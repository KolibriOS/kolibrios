...
mouse:
  ...
  test word [edit1.flags],10b;ed_focus ; Ґб«Ё ­Ґ ў д®ЄгбҐ, ўле®¤Ё¬
  jne still
...
;    jne still
  ...
  test word [edit2.flags],10b;ed_focus ; Ґб«Ё ­Ґ ў д®ЄгбҐ, ўле®¤Ё¬
  je @f
    cmp ah,0x80 ;if key up
    ja still
    cmp ah,42 ;[Shift] (left)
...
txtErrOpen db 'ЌҐ ­ ©¤Ґ­ д ©«, Їа®ўҐамвҐ Їа ўЁ«м­®бвм Ё¬Ґ­Ё',0
