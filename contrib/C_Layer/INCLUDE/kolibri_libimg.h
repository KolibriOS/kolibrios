...
typedef struct {
  ...
  /// @brief Used iff Image.IsAnimated is set in Flags
  uint32_t Delay;
...
/// @param img
/// @param length
/// @param option Value from enum @link Encode
/// @return
...
/// @param dst NULL
/// @param scale_type Scale type, value from enum @link Scale
/// @param inter Interpolation algorithm, value from enum @link Inter. 
