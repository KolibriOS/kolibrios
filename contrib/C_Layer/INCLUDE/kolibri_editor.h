...
typedef struct __attribute__ ((__packed__)) {
    ...
    uint32_t    width;  //440
    uint32_t    hight;  //150
    uint32_t    w_pane;      //30 ������ ������ � ����, width of left pane with line numbers
    uint32_t    h_pane;      //25 ������ ������ � ����, hight of top pane with Rows, Cols Undo info
	...
	editor_callback fun_on_key_ctrl_all;  // ��������� �� ������� ���������� ��� ������� Ctrl+N,O,S,F,G,H, can be NULL
	uint32_t    reserved_1;  // ...
	uint32_t    reserved_2;  // ...
	uint32_t    reserved_3;  // ...
	...
	editor_callback fun_draw_panels;    // ��������� �� ������� ��������� ������ ������|������|��������|����������
	uint32_t    reserved_4;  // ...
