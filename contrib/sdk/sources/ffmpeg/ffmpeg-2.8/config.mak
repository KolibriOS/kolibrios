...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=32 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -DZLIB_CONST
CFLAGS=  -I../../newlib/libc/include -I../../zlib -I../../vaapi/libva-1.6.2 -U_Win32 -U_WIN32 -U__MINGW32__
CFLAGS+= -std=c99 -fno-ident -fomit-frame-pointer -Wdeclaration-after-statement -Wdisabled-optimization
CFLAGS+= -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wmissing-prototypes
CFLAGS+= -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch
CFLAGS+= -Wformat -Wno-format-zero-length -Wno-pointer-sign -O2 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize
CFLAGS+= -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes
CFLAGS+= -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -I../../newlib/libc/include -I../../zlib -U_Win32 -U_WIN32 -U__MINGW32__
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
HOSTCC=gcc
HOSTLD=gcc
HOSTCFLAGS=  -std=c99 -Wall -O2
HOSTCPPFLAGS= -D_ISOC99_SOURCE -U__STRICT_ANSI__
HOSTEXESUF=.exe
HOSTLDFLAGS=
HOSTLIBS=-lm
DEPHOSTCC=gcc
