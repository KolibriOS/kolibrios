...
enum opt_code
{
  ...
  OPT_Wpedantic_ms_format = 329,             /* -Wpedantic-ms-format */
  ...
  OPT_fset_stack_executable = 940,           /* -fset-stack-executable */
  ...
  OPT_fwritable_relocated_rdata = 1092,      /* -fwritable-relocated-rdata */
  ...
  OPT_m128bit_long_double = 1139,            /* -m128bit-long-double */
  OPT_m16 = 1140,                            /* -m16 */
  OPT_m32 = 1141,                            /* -m32 */
  OPT_m3dnow = 1142,                         /* -m3dnow */
  OPT_m3dnowa = 1143,                        /* -m3dnowa */
  OPT_m64 = 1144,                            /* -m64 */
  OPT_m80387 = 1145,                         /* -m80387 */
  OPT_m8bit_idiv = 1146,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1147,             /* -m96bit-long-double */
  OPT_mabi_ = 1148,                          /* -mabi= */
  OPT_mabm = 1149,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1150,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1151,                 /* -maddress-mode= */
  OPT_madx = 1152,                           /* -madx */
  OPT_maes = 1153,                           /* -maes */
  OPT_malign_data_ = 1154,                   /* -malign-data= */
  OPT_malign_double = 1155,                  /* -malign-double */
  OPT_malign_functions_ = 1156,              /* -malign-functions= */
  OPT_malign_jumps_ = 1157,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1158,                  /* -malign-loops= */
  OPT_malign_stringops = 1159,               /* -malign-stringops */
  ...
  OPT_mconsole = 1182,                       /* -mconsole */
  /* OPT_mcpu_ = 1183, */                    /* -mcpu= */
  OPT_mcrc32 = 1184,                         /* -mcrc32 */
  OPT_mcx16 = 1185,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1186,            /* -mdispatch-scheduler */
  OPT_mdll = 1187,                           /* -mdll */
  OPT_mdump_tune_features = 1188,            /* -mdump-tune-features */
  OPT_mf16c = 1189,                          /* -mf16c */
  OPT_mfancy_math_387 = 1190,                /* -mfancy-math-387 */
  OPT_mfentry = 1191,                        /* -mfentry */
  OPT_mfma = 1192,                           /* -mfma */
  OPT_mfma4 = 1193,                          /* -mfma4 */
  OPT_mforce_drap = 1194,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1195,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1196,                       /* -mfpmath= */
  OPT_mfsgsbase = 1197,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1198, */              /* -mfused-madd */
  OPT_mfxsr = 1199,                          /* -mfxsr */
  ...
  OPT_mnop_fun_dllimport = 1226,             /* -mnop-fun-dllimport */
  ...
  OPT_mpe_aligned_commons = 1234,            /* -mpe-aligned-commons */
  OPT_mpopcnt = 1235,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1236,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1237,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1238,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1239,                        /* -mprfchw */
  OPT_mpush_args = 1240,                     /* -mpush-args */
  OPT_mrdrnd = 1241,                         /* -mrdrnd */
  OPT_mrdseed = 1242,                        /* -mrdseed */
  OPT_mrecip = 1243,                         /* -mrecip */
  OPT_mrecip_ = 1244,                        /* -mrecip= */
  OPT_mrecord_mcount = 1245,                 /* -mrecord-mcount */
  OPT_mred_zone = 1246,                      /* -mred-zone */
  OPT_mregparm_ = 1247,                      /* -mregparm= */
  OPT_mrtd = 1248,                           /* -mrtd */
  OPT_mrtm = 1249,                           /* -mrtm */
  OPT_msahf = 1250,                          /* -msahf */
  OPT_msha = 1251,                           /* -msha */
  OPT_mskip_rax_setup = 1252,                /* -mskip-rax-setup */
  OPT_msoft_float = 1253,                    /* -msoft-float */
  OPT_msse = 1254,                           /* -msse */
  OPT_msse2 = 1255,                          /* -msse2 */
  OPT_msse2avx = 1256,                       /* -msse2avx */
  OPT_msse3 = 1257,                          /* -msse3 */
  OPT_msse4 = 1258,                          /* -msse4 */
  OPT_msse4_1 = 1259,                        /* -msse4.1 */
  OPT_msse4_2 = 1260,                        /* -msse4.2 */
  OPT_msse4a = 1261,                         /* -msse4a */
  /* OPT_msse5 = 1262, */                    /* -msse5 */
  OPT_msseregparm = 1263,                    /* -msseregparm */
  OPT_mssse3 = 1264,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1265,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1266,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1267,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1268,            /* -mstringop-strategy= */
  OPT_mtbm = 1269,                           /* -mtbm */
  OPT_mthreads = 1270,                       /* -mthreads */
  OPT_mtls_dialect_ = 1271,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1272,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1273,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1274,                         /* -mtune= */
  OPT_muse_libstdc_wrappers = 1275,          /* -muse-libstdc-wrappers */
  OPT_mveclibabi_ = 1276,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1277,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1278,                    /* -mvzeroupper */
  OPT_mwin32 = 1279,                         /* -mwin32 */
  OPT_mwindows = 1280,                       /* -mwindows */
  OPT_mx32 = 1281,                           /* -mx32 */
  OPT_mxop = 1282,                           /* -mxop */
  OPT_mxsave = 1283,                         /* -mxsave */
  OPT_mxsavec = 1284,                        /* -mxsavec */
  OPT_mxsaveopt = 1285,                      /* -mxsaveopt */
  OPT_mxsaves = 1286,                        /* -mxsaves */
  OPT_n = 1287,                              /* -n */
  OPT_no_canonical_prefixes = 1288,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1289,              /* -no-integrated-cpp */
  OPT_no_pthread = 1290,                     /* -no-pthread */
  OPT_nocpp = 1291,                          /* -nocpp */
  OPT_nodefaultlibs = 1292,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1293,                   /* -nostartfiles */
  OPT_nostdinc = 1294,                       /* -nostdinc */
  OPT_nostdinc__ = 1295,                     /* -nostdinc++ */
  OPT_nostdlib = 1296,                       /* -nostdlib */
  OPT_o = 1297,                              /* -o */
  OPT_p = 1298,                              /* -p */
  OPT_pass_exit_codes = 1299,                /* -pass-exit-codes */
  /* OPT_pedantic = 1300, */                 /* -pedantic */
  OPT_pedantic_errors = 1301,                /* -pedantic-errors */
  OPT_pg = 1302,                             /* -pg */
  OPT_pie = 1303,                            /* -pie */
  OPT_pipe = 1304,                           /* -pipe */
  OPT_posix = 1305,                          /* -posix */
  OPT_print_file_name_ = 1306,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1307,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1308,          /* -print-multi-directory */
  OPT_print_multi_lib = 1309,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1310,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1311,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1312,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1313,               /* -print-prog-name= */
  OPT_print_search_dirs = 1314,              /* -print-search-dirs */
  OPT_print_sysroot = 1315,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1316,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1317,                        /* -pthread */
  OPT_quiet = 1318,                          /* -quiet */
  OPT_r = 1319,                              /* -r */
  OPT_remap = 1320,                          /* -remap */
  OPT_s = 1321,                              /* -s */
  OPT_s_bc_abi = 1322,                       /* -s-bc-abi */
  OPT_save_temps = 1323,                     /* -save-temps */
  OPT_save_temps_ = 1324,                    /* -save-temps= */
  OPT_shared = 1325,                         /* -shared */
  OPT_shared_libgcc = 1326,                  /* -shared-libgcc */
  /* OPT_specs = 1327, */                    /* -specs */
  OPT_specs_ = 1328,                         /* -specs= */
  OPT_static = 1329,                         /* -static */
  OPT_static_libasan = 1330,                 /* -static-libasan */
  OPT_static_libgcc = 1331,                  /* -static-libgcc */
  OPT_static_libgcj = 1332,                  /* -static-libgcj */
  OPT_static_libgfortran = 1333,             /* -static-libgfortran */
  OPT_static_libgo = 1334,                   /* -static-libgo */
  OPT_static_liblsan = 1335,                 /* -static-liblsan */
  OPT_static_libmpx = 1336,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1337,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1338,               /* -static-libstdc++ */
  OPT_static_libtsan = 1339,                 /* -static-libtsan */
  OPT_static_libubsan = 1340,                /* -static-libubsan */
  /* OPT_std_c__03 = 1341, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1342, */                /* -std=c++0x */
  OPT_std_c__11 = 1343,                      /* -std=c++11 */
  OPT_std_c__14 = 1344,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1345, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1346, */                /* -std=c++1y */
  OPT_std_c__1z = 1347,                      /* -std=c++1z */
  ...
  /* OPT_std_gnu__17 = 1364, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1365, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1366,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1367,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1368,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1369, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1370, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1371,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1372,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1373, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1374, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1375,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1376, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1377, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1378, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1379,                     /* -std=legacy */
