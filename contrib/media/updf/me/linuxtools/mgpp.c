...
#if (HAS_DEVENV==1)
 sprintf(buf,"%s -c %s -o %s -nostdinc -fno-builtin -fno-stack-protector -I/dev/env/MENUETDEV/include -fno-common "
	     "-I/dev/env/MENUETDEV/include/STL "
             "-O1 -fno-rtti -fno-exceptions -fomit-frame-pointer -D__MENUETOS__ ",TOOLNAME,argv[1],argv[2]);
#else
 sprintf(buf,"%s -c %s -o %s -nostdinc -fno-builtin -fno-stack-protector -I%s/include -fno-common "
